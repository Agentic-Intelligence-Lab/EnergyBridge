...
class RoleplayUserSimulator:
    ...
    def generate_feedback(
        ...
        user_prompt = (
            ...
            "- For low_incentive or price_indifferent users, small cost/bill savings should not dominate satisfaction; comfort, routine smoothness, and whether the controller avoided annoying savings pitches matter more.\n"
