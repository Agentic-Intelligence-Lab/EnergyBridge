...
1. Uses the actual EnergyPlus hvac_power_kw (read via StateReader) as baseline.
...
def build_ep_control_plan(
    ...
    home_state:
        Current home state dict including EP-sourced hvac_power_kw,
    ...
    hvac_kw = float(home_state.get("hvac_power_kw", 0.0))
    ...
    return {
        ...
        "baseline_hvac_kw": round(hvac_kw, 3),
