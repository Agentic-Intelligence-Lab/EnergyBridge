...
Both trained on `all_appliances_full` persona (washer + dishwasher + water_heater + EV),
96 parallel EnergyPlus envs, 7-dim action space.
...
| 1 | Washer start hour | [8, 23] h |
| 2 | Dishwasher start hour | [9, 23] h |
| 3 | WH preheat start hour | [7, 17] h |
| 4 | WH target temperature | [45, 75] °C |
| 5 | EV charge start hour | [12, 30] h |
| 6 | EV charge end hour | [0, 14] h |
